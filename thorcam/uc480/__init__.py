...
class uc480:
    ...
    def __init__(self):
        ...
        self.frame = np.zeros((1024,1280,3))
    ...
    def start_live(self):
        self.call("is_CaptureVideo", self._camID, IS_WAIT)
        
    def stop_live(self):
        self.call("is_StopLiveVideo", self._camID, IS_WAIT)
    
    def read(self):
        gray = cv2.rotate(self.get_buffer().astype(np.uint8), cv2.ROTATE_180)
